  ...
  return (
    <div className="about-wrapper m-0 p-0">
      ...
      <div className="color-body">
        ...
        <section className=" py-5 bg-light mb-0 ">
          <Container>
            <Row className="align-items-center g-4">
              <Col md={6}>
                ...
                <p>
                  Welcome to Mimi's Restaurant, where passion meets flavor. We
                  are dedicated to providing a unique dining experience with
        ...
        <section className=" py-4 bg-white mb-0">
          <Container>
            <Row className="g-3">
              <Col md={6}>
                <img
